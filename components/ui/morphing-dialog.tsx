...
function MorphingDialog({ children, transition }: MorphingDialogProviderProps) {
  return (
...
function MorphingDialogContainer({ children }: { children: ReactNode }) {
...
function MorphingDialogSubtitle({ children, className, style }: MorphingDialogTitleProps) {
  const { uniqueId } = useMorphingDialog();

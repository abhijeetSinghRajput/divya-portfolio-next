...
// In your AdvancedThemeToggle.tsx, replace the useThemeToggle hook with this:
export const useThemeToggle = ({
  ...
  const { theme, setTheme } = useTheme(); // Use your theme provider
  ...
  return (
    <TooltipWrapper content="Theme">
      <Button
        variant="outline"
        size="icon"
        className={cn("rounded-xl size-10 bg-muted/50", className)}
        aria-label="Toggle theme"
        onClick={toggleTheme}
        onMouseEnter={startAnim}
        onMouseLeave={stopAnim}
      >
        <SunIcon ref={sunRef} className="transition-all hidden dark:block" />
        <MoonIcon ref={moonRef} className="transition-all dark:hidden" />
